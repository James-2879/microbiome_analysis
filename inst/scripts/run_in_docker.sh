...
docker exec microbiome-analysis-container Rscript /usr/local/bin/microbiome_analysis/cmdline_util.R --function do_pcoa --data data/input/all_samples.tsv --output data/output/pcoa.jpeg 
